...
export class GpsService {
  ...
  constructor(private geolocation: Geolocation) {
    ...
    // might need to change from null
    this.currentGrid =  new BehaviorSubject(null).asObservable().pipe(
      merge(firstGpsObs, afterFirstGpsObs));
  }

  private isOutOfGrid(geoPosition: Geoposition) {
    try{
      // distance returns in meters
      ...
      console.log('isOutOfGrid failed: ');
      console.log(error);
    }
  }
